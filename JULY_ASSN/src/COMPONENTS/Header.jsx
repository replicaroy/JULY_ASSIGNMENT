...
//           </span>
//         </div>
//       <div className="menubar md:hidden font-bold text-5xl cursor-pointer mt-[-12px]  " onClick={(e)=> menu(e)}
//         >
//       { menus  ? <i class="fa-solid fa-bars text-4xl "> </i> : <i class="fa-solid fa-x text-4xl "></i> } 
       
//         </div>
//       </div>
//       <div className={`menu  absolute shadow z-100000 top-16 right-0 w-50 bg-white text-fuchsia-800
//        items-center flex-col h-screen py-10 gap-10 ${menus? "hidden" : "flex"}` } style={{transition: '.4s ease'}} >
//   <Link to="/" style={{ textDecoration: "none" }}>Men</Link>
//   <Link to="/women" style={{ textDecoration: "none" }}>Women</Link>
//   <Link to="/girls" style={{ textDecoration: "none" }}>Girls</Link>
//   <Link to="/about" style={{ textDecoration: "none" }}>About</Link>
